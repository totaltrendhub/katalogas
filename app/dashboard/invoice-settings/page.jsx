// app/dashboard/invoice-settings/page.jsx
...
async function saveInvoiceSettings(formData) {
  ...
  if (hasError(profileError)) {
    ...
    redirect("/dashboard/invoice-settings?error=1");
  }
  ...
  // Ne dedam "|| null", kad į NOT NULL stulpelius nesiųstume NULL
  const payload = {
  ...
  redirect("/dashboard/invoice-settings?success=1");
}
